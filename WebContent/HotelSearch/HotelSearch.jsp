			...
			<table>
				...
				<tr>
					<td class="padding"><a href="#"><c:out
								value="${requestScope.hotelList.itemCode}" /></a></td>
					<td class="padding"><c:out
							value="${requestScope.hotelList.hotelName}" /></td>
					<td class="number"><c:out
							value="${requestScope.hotelList.price}" /></td>
					<td class="number"><c:out
							value="${requestScope.hotelList.stock}" /></td>
				</tr>
				<%--</c:forEach>--%>
			</table>
		</div>
